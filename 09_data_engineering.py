...
# ================================================================
ats_grouped = pd.read_csv('ats_grouped_by_invoice.csv')
invoice_grouped = pd.read_csv('invoice_grouped_by_invoice.csv')
...
# Save all outputs
# ================================================================
ats_grouped.to_csv('ats_grouped_with_discounts.csv', index=False)
invoice_grouped.to_csv('invoice_grouped_with_discounts.csv', index=False)
results.to_csv('discount_analysis_results.csv', index=False)

print("\n" + "="*70)
print("SAVED FILES:")
print("="*70)
print("- ats_grouped_with_discounts.csv (includes invoice_period)")
print("- invoice_grouped_with_discounts.csv (includes invoice_period)")
print("- discount_analysis_results.csv")
