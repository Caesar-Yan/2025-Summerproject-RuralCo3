...
# Filter to FY2025 only (April 1, 2024 - March 31, 2025)
...
output_csv = os.path.join(OUTPUT_DIR, 'FY2025_comparison_summary.csv')
...
# ================================================================
output_excel = os.path.join(OUTPUT_DIR, 'FY2025_detailed_simulations.xlsx')
...
ax1.set_title('FY2025 - WITH DISCOUNT: Invoice Amounts vs Credit Card Revenue', 
...
ax2.set_title('FY2025 - NO DISCOUNT: Invoice Amounts vs Credit Card Revenue', 
              fontsize=14, fontweight='bold')
...
ax3.set_title('FY2025 - Cumulative Credit Card Revenue Comparison', 
              fontsize=14, fontweight='bold')
...
ax4.set_title('FY2025 - Monthly Revenue Components: Interest vs Late Fees', 
              fontsize=14, fontweight='bold')
...
plt.tight_layout()
output_viz = os.path.join(OUTPUT_DIR, 'FY2025_revenue_analysis_visualization.png')
...
print("\n" + "="*70)
print("ANALYSIS COMPLETE - FY2025")
print("="*70)
print(f"\nAll results saved to folder: {OUTPUT_DIR}/")
print("Files created:")
print(f"  1. FY2025_comparison_summary.csv - Summary comparison table")
print(f"  2. FY2025_detailed_simulations.xlsx - Full simulation data (both scenarios)")
print(f"  3. FY2025_revenue_analysis_visualization.png - 4-panel visualization")
print("="*70)