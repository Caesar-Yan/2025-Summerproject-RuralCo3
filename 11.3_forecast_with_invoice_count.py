...
ax.set_title('Monthly Discounted Price - Historical & Forecast', fontsize=21, fontweight='bold')
ax.set_xlabel('Period', fontsize=18, fontweight='bold')
ax.set_ylabel('Discounted Price ($)', fontsize=18, fontweight='bold')
...
ax.set_xlabel('Actual Discounted Price ($)', fontsize=18, fontweight='bold')
ax.set_ylabel('Predicted Discounted Price ($)', fontsize=18, fontweight='bold')
ax.legend(fontsize=17)
ax.grid(True, alpha=0.3)
...
ax.set_title(f'Monthly Invoice Count\n(Used as Feature in Discounted Price Model)', 
              fontsize=21, fontweight='bold')
ax.set_xlabel('Period', fontsize=18, fontweight='bold')
ax.set_ylabel('Invoice Count', fontsize=18, fontweight='bold')
ax.legend(fontsize=17)
ax.grid(True, alpha=0.3)
ax.yaxis.set_major_formatter(plt.FuncFormatter(lambda x, p: f'{x:,.0f}'))
ax.xaxis.set_major_formatter(mdates.DateFormatter('%Y-%m'))
