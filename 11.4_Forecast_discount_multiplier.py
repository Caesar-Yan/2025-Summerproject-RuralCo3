...
ax.set_ylabel('Discount Rate (%)', fontsize=18, fontweight='bold')
...
ax.set_title(f'Model Fit: {best_model_name}\nR² = {best_model_info["r2"]:.4f}, MAE = {best_model_info["mae"]:.4f}%',
              fontsize=21, fontweight='bold')
ax.set_xlabel('Actual Discount Rate (%)', fontsize=18, fontweight='bold')
ax.set_ylabel('Predicted Discount Rate (%)', fontsize=18, fontweight='bold')
ax.legend(fontsize=17)
ax.grid(True, alpha=0.3)
...
ax.set_title('Model Residuals Over Time', fontsize=21, fontweight='bold')
ax.set_xlabel('Period', fontsize=18, fontweight='bold')
ax.set_ylabel('Residual (Actual - Predicted) (%)', fontsize=18, fontweight='bold')
ax.grid(True, alpha=0.3)
ax.xaxis.set_major_formatter(mdates.DateFormatter('%Y-%m'))
ax.tick_params(axis='x', rotation=45, labelsize=14)
ax.tick_params(axis='y', labelsize=14)
