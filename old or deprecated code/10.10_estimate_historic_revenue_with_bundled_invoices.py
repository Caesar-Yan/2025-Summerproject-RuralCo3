'''
10.10_estimate_historic_revenue_with_bundled_invoices - Monte Carlo with Statement-Level Analysis
...
print("\n" + "="*70)
print("MONTE CARLO SIMULATION WITH BUNDLED STATEMENTS")
print("="*70)
...
# ================================================================
# Load BUNDLED invoices (already has statement_id and decile)
# ================================================================
print("\n" + "="*70)
...
# Verify statement_id and decile columns exist
...
# ================================================================
# Aggregate invoices to STATEMENT level (using pre-assigned statement_id)
# ================================================================
print("\n" + "="*70)
print("AGGREGATING TO STATEMENT LEVEL")
print("="*70)

# Aggregate by statement_id (which already groups related invoices)
statements_fy2025 = fy2025_invoices.groupby(['statement_id', 'invoice_period', 'decile']).agg({
...
statements_fy2025.columns = [
    'statement_id', 'invoice_period', 'decile',
...
# ================================================================
print("\n" + "="*70)
print("MONTE CARLO RESULTS SUMMARY (STATEMENT-BASED)")
print("="*70)
...
# ================================================================
print("\n" + "="*70)
print("MONTE CARLO SIMULATION COMPLETE (STATEMENT-BASED)")
print("="*70)
...
print("\n" + "="*70)
print("KEY DIFFERENCE FROM 10.8:")
print("  10.8: Individual invoices as payment units")
print("  10.10: Statements (bundled invoices) as payment units")
print("  Statement-based is more realistic - customers pay statements, not invoices")
print("="*70)